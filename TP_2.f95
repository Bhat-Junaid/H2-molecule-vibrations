! This program finds eigenvalues with the centrifugal term present in the potential
PROGRAM SCHROD
    IMPLICIT NONE
    ...
    DATA R0/0.1D0/, RN/2.6D0/, A/1.3924/, B/1.4840D-03/, EPS/1.0D-04/, TOL/1.0D-04/,&
    FINIT/0.D0/, ENERG/-0.9502D0/, NCMAX/30/, IFLAG/1/, M/11/, JLEV/1/
    ...
    OPEN(UNIT=1,FILE="Wavefunction_try.txt")
    DO I=0,N
    ...
    DO I=0,N
    RR(I)=R0+I*H
    V(I)=DEXP(-2.D0*A*(RR(I)-1.D0))-2.D0*DEXP(-A*(RR(I)-1.D0)) + B*(JLEV*(JLEV+1))/RR(I)**2
    ENDDO
    RETURN
    END
